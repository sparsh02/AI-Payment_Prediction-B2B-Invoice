...
public class edit extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			InvoiceModel run=new Gson().fromJson(request.getReader(),InvoiceModel.class);
			String query="UPDATE winter_internship SET invoice_currency=?, cust_payment_terms=?";
